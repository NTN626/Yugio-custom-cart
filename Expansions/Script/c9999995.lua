...
function s.initial_effect(c)
	aux.AddCodeList(c,89631139)  -- “Blue-Eyes White Dragon”
	aux.AddCodeList(c,63436931)  -- “Crimson Dragon”
...
function s.sumlimit(e,c,sump,sumpos,targetp,se)
	return c:IsLocation(LOCATION_EXTRA)
	   and not (c:IsRace(RACE_DRAGON) and c:IsAttribute(ATTRIBUTE_LIGHT))
end
...
function s.repfilter(c,tp)
	return c:IsFaceup()
	   ...
	   and ( c:IsCode(63436931)									 -- “Crimson Dragon”
		 or (c:IsRace(RACE_DRAGON) and c:IsType(TYPE_SYNCHRO) and c:IsLevel(9)) )
