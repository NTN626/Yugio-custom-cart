...
function s.initial_effect(c)
	-- (1) When Normal Summoned: Set 1 “Flame Chasers” Spell/Trap from Deck
...
function s.setfilter(c)
	return c:IsSetCard(0x8b4) and c:IsType(TYPE_SPELL+TYPE_TRAP) and c:IsSSetable()
end
