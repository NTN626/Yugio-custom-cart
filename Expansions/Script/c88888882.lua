...
function s.initial_effect(c)
	aux.AddCodeList(c,88888800,88888881)
...
function s.cfilter(c,tp,se)
	return c:IsFaceup() and c:IsSummonPlayer(tp) and c:IsCode(88888800)
...
function s.spfilter2(c,e,tp)
	return (c:IsCode(88888800) or (c:IsLevel(1) and c:IsType(TYPE_TUNER) and c:IsAttribute(ATTRIBUTE_LIGHT)))
